                        ...
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                <h2 class="section-heading mb-4">
                                    <span class="section-heading-lower">Despre cafeaua noastră</span>
                                </h2>
                                <p>Colaborăm cu producători pasionați din diverse regiuni ale globului, cum ar fi Columbia, Brazilia și Etiopia. Aceste zone geografice oferă condiții ideale pentru cultivarea boabelor de cafea, inclusiv altitudine optimă, climat variat și soluri fertile. De la plantațiile mici și familiale, aflate adesea în inima regiunilor montane sau în jurul munților, aducem boabele de cea mai înaltă calitate. În căutarea celor mai bune boabe, avem în vedere criterii precum maturitatea, calitatea și profilul aromatic. Fiecare lot de boabe este selectat cu atenție pentru a asigura că ne îndeplinim standardele ridicate. În laboratorul nostru de prăjire, boabele noastre sunt tratate cu o atenție deosebită pentru ca tu să te bucuri de cea mai bună experiență.</p>
                                <iframe width="730" height="400" src="https://www.youtube.com/embed/vFcS080VYQ0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
